...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 pt-4 pb-10 text-center">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl shadow-2xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="bg-white p-8 col-span-2">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Sambutan <span className="text-blue-600">Kepala Desa</span></h2>
